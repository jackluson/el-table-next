...
declare type eventJsx = CamelEventKey<
...
declare type OmitTableProp = Required<
  Omit<ElTableProps, 'data' | 'class' | eventKey>
>;
...
declare type MergeTableProps = typeof tableProps &
  eventMethodProps & {
...
declare const ElTableNext: vue.DefineComponent<
  {
    ...
    summaryMethod: PropType<(...param: any[]) => string[]> &
      PropType<
        element_plus_lib_components_table_src_table_defaults.SummaryMethod<any>
      >;
    ...
    rowClassName: PropType<
      element_plus_lib_components_table_src_table_defaults.ColumnCls<any>
    >;
    rowStyle: PropType<
      element_plus_lib_components_table_src_table_defaults.ColumnStyle<any>
    >;
    ...
    load: PropType<
      (
        row: any,
        treeNode: element_plus_lib_components_table_src_table_defaults.TreeNode,
  ...
  Readonly<
    {
      ...
      defaultSort?:
        | element_plus_lib_components_table_src_table_defaults.Sort
        | undefined;
